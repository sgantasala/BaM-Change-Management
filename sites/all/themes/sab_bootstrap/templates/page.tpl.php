...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?> clearfix <?php if (template_is_program_details_page()): ?>program-details-page<?php endif; ?>">
    <div class="container">
        <div id="header-container" class="clearfix">
            ...
            <div id="header-w-banner" class="clearfix">
                <?php endif;?>
            ...
            <?php if (!empty($page['below_header'])): ?>
...
<div class="main-container container">
    ...
    <?php if (!template_is_program_details_page()): ?>

    <section class="<?php print $content_column_class; ?> clearfix">
        ...
        <?php print render($page['homepage_content_ads']); ?>

        <?php print render($page['homepage_content_middle']); ?>

        <?php if(!empty($page['homepage_column_content'])):?>
        <div class="homepage-content-columns clearfix">
            <?php print render($page['homepage_column_content']); ?>
        </div>
        <?php endif;?>
        ...
        <?php if($is_front):?>
        <?php print render($page['homepage_content_bottom']); ?>
        <?php endif;?>

    </section>

    <?php if (!$is_front && !empty($page['sidebar_first'])): ?>
    <aside class="<?php print $side_bar_column; ?> clearfix" role="complementary">
    ...
    <?php if (template_is_program_details_page()): ?>
    <?php print $messages; ?>
    <div class="program-details-page program-details-holder" itemscope="" itemtype="http://schema.org/CollegeOrUniversity">
        <div class="row">
            <div class="col-md-12">
                <?php print render($page['program_details_page_banner']);  ?>
            </div>
        </div>

        <div class="row columns-content">
            <div class="col-xs-12 col-sm-6">
                <?php print render($page['content_column_one']);  ?>
            </div>
            <div class="col-xs-12 col-sm-6">
                <?php print render($page['content_column_two']);  ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?php print render($page['program_details_page_footer']);  ?>
            </div>
        </div>
    </div>
    <?php endif; ?>
